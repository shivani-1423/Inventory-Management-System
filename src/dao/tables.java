...
public class tables {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //st.executeUpdate("insert into appuser (userRole,name,mobileNumber,email,password,address,status) values('SuperAdmin','Super Admin','1234567890','superadmin@testemail.com','admin123','India','Active')");
